 ...
 * 获取指定年份的农历节日公历日期
 */
export function getLunarFestivalDate(festivalName: string, year: number): string | null {
...
export function getFestivalsForYear(year: number): Festival[] {
  ...
  const solarTerms: Festival[] = [
    {
      name: '立春',
      date: '02-04',
      time: '09:00',
      description: '春季的开始，万物复苏',
      category: 'solar-term'
    },
    {
      name: '雨水',
  ...
  // 现代节日（公历固定日期）
  const modernFestivals: Festival[] = [
    {
      name: '元旦',
      date: '01-01',
      time: '00:00',
  ...
  // 西方节日
  const westernFestivals: Festival[] = [
    {
      name: '万圣节',
      date: '10-31',
      time: '18:00',
      description: '南瓜灯和糖果的夜晚',
      category: 'western'
    },
    {
      name: '感恩节',
